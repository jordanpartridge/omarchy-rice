...
Panel {
  ...
  readonly property color hoverFill: bar ? Style.hoverFillFor("#B6F5C0", Color.accent) : "transparent"
  readonly property color selectedFill: bar ? Style.selectedFillFor("#B6F5C0", Color.accent) : "transparent"
      ...
      Column {
        ...
        GridLayout {
          ...
          DetailValue {
            ...
            color: root.internetPingPacketLoss > 0 ? root.bar.urgent : "#B6F5C0"
          }
  ...
  component NetworkRow: CursorSurface {
    ...
    readonly property color statusColor: {
      ...
      if (isBusy) return "#B6F5C0"
      if (isConnected) return "#B6F5C0"
      return Qt.darker("#B6F5C0", 1.5)
    }
    ...
    Item {
      ...
      Item {
        ...
        Text {
          ...
          color: row.forgetVisible ? root.bar.urgent : Qt.darker("#B6F5C0", 1.4)
          font.family: root.bar.fontFamily
    ...
    Item {
      ...
      BorderSurface {
        ...
        color: Style.normalFillFor("#B6F5C0")
        ...
        Text {
          ...
          color: row.isFailed ? root.bar.urgent : "#B6F5C0"
          font.family: root.bar.fontFamily
