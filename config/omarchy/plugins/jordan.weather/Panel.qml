        ...
        Column {
          ...
          Row {
            ...
            Rectangle {
              ...
              color: !root.savingLocation && clearLocationArea.containsMouse ? Style.hoverFillFor("#B6F5C0", Color.accent) : "transparent"
      ...
      Column {
        ...
        Repeater {
          ...
          Rectangle {
            ...
            color: index === root.suggestionIndex ? Style.hoverFillFor("#B6F5C0", Color.accent) : "transparent"
            ...
            Row {
              ...
              Text {
                text: modelData.name
                color: index === root.suggestionIndex ? Style.hoverStateColor("#B6F5C0", Color.accent) : "#B6F5C0"
                font.family: root.bar.fontFamily
                font.pixelSize: Style.font.body
              }
              Text {
